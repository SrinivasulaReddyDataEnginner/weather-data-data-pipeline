...
TABLE_NAME = "COMPARISON_PRICE_TABLE"
FETCH_TYPE = "BOOTSTRAP"
DATA_FETCH_TASK = "DATA_FETCH"
...
with models.DAG("parpal-comparison-price-bootstrap-dag", start_date=datetime(2023, 11, 18), schedule_interval= '@hourly', catchup = False) as dag:
